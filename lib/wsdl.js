...
WSDL.prototype._initializeOptions = function (options) {
  ...
  var ignoreChildNameSpaces = options ? options.ignoreChildNameSpaces : null;
  if(ignoreChildNameSpaces !== null && typeof ignoreChildNameSpaces !== 'undefined')
    this.options.ignoreChildNameSpaces = ignoreChildNameSpaces;
  else
    this.options.ignoreChildNameSpaces = this.ignoreChildNameSpaces;
            ...
            if (childSchemaObject &&
              ...
              if (elementQName) {
                ...
                if (elementQName.prefix === TNS_PREFIX) {
                  ...
                  if (self.options.ignoreChildNameSpaces) {
                    childNsPrefix = '';
                  }
                } else {
